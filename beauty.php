<?php
   ...
   $category_query = mysqli_query($conn, "SELECT DISTINCT type FROM category where main_category='Beauty'")
...
<!-- sub header, items fetched from the database -->
   <section class="sub_header">
    <div class="flex">
        <a href="#" class="sub-logo">Beauty</a>
    </div>
   ...
   <div class="box-container">
      <?php  
         ...
         JOIN category c ON pc.category_id = c.category_id WHERE c.main_category = 'Beauty' AND c.type = '$selectedCategory'") 
         or die('query failed');
        ...
        ?>
         ...
         <form action="Beauty.php" method="post" class="box" data-name="<?php echo $fetch_product['product_id']; ?>">
...
<?php } ?>
 ...
 <section class="Categories">
     <form action="" method="post" class="box">
      <img class="image" src="uploaded_img/Makeup.jpeg" alt="">
      <button type="submit" name="category" value="Makeup" class="option_btn">Makeup</button>
     </form>
     <form action="" method="post" class="box">
      <img class="image" src="uploaded_img/Skincare.jpg" alt="">
      <button type="submit" name="category" value="Skin_care" class="option_btn">Skin care</button>
     </form>
     <form action="" method="post" class="box">
      <img class="image" src="uploaded_img/HairCare".jpeg" alt="">
      <button type="submit" name="category" value="Hair_care" class="option_btn">Hair care</button>
     </form>
     <form action="" method="post" class="box">
      <img class="image" src="uploaded_img/Perfumes.jpeg" alt="">
      <button type="submit" name="category" value="Perfumes" class="option_btn">Perfumes</button>
     </form>  
  </section>
