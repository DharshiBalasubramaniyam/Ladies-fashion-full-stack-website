<?php
   ...
   $category_query = mysqli_query($conn, "SELECT DISTINCT type FROM category where main_category='Accessories'")
...
<!-- sub header, items fetched from the database -->
   <section class="sub_header">
    <div class="flex">
        <a href="#" class="sub-logo">Accessories</a>
    </div>
...
<?php } ?>
 ...
 <!-- When entering to the accessories these categories will  be shown -->
 <section class="Categories">
     <form action="" method="post" class="box">
      <img class="image" src="uploaded_img/Bags.jpg" alt="">
      <button type="submit" name="category" value="Bags" class="option_btn">Bags</button>
     </form>
     <form action="" method="post" class="box">
      <img class="image" src="uploaded_img/Jewelry.png" alt="">
      <button type="submit" name="category" value="Jewelry" class="option_btn">Jewelry</button>
     </form>
     <form action="" method="post" class="box">
      <img class="image" src="uploaded_img/Hats.jpg" alt="">
      <button type="submit" name="category" value="Hats" class="option_btn">Hats</button>
     </form>
     <form action="" method="post" class="box">
      <img class="image" src="uploaded_img/SunGlasses.jfif" alt="">
      <button type="submit" name="category" value="Sun glasses" class="option_btn">Sun glasses</button>
     </form> 
     <form action="" method="post" class="box">
      <img class="image" src="uploaded_img/Watches.webp" alt="">
      <button type="submit" name="category" value="Watches" class="option_btn">Watches</button>
     </form>  
   </section>
