    ...
    <header>
        <div class="top-header">
            ...
            <div class="top-header-right">
                <?php
                    ...
                    if (isset($_SESSION['isLogged']) && !$_SESSION['isLogged']) {
                        ...
                        echo "<span class='user laptop-setup'>" . 
                                 "<a href='./account/logout.php'>sign out</a><a href='./myaccount/dashboard.php'><i class='fa fa-user-circle-o' aria-hidden='true'></i></a>" .
                             "</span>";
                    }
                ...
                <span><a href="./myaccount/cart.php"><i class="fa fa-shopping-bag" aria-hidden="true"></i></a><span><?php echo $no_of_cart_items; ?></span></span>
        ...
        <div class="bottom-header">
            <ul>
                ...
                <?php
                    if (isset($_SESSION['isLogged']) && $_SESSION['isLogged']) {
                        echo "<li class='mobile-setup'><a href='./myaccount/dashboard.php'>My Account</a> </li>" . 
