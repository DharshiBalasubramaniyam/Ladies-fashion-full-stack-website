...
--
ALTER TABLE `placed_order`
  ADD CONSTRAINT `placed_order_ibfk_1` FOREIGN KEY (`billing_address_id`) REFERENCES `user_address` (`address_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `placed_order_ibfk_2` FOREIGN KEY (`shipping_address_id`) REFERENCES `user_address` (`address_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `product_color`
  ADD CONSTRAINT `product_color_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`) ON DELETE CASCADE ON UPDATE CASCADE;
